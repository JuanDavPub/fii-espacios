                  ...
                  <tr key={tipo.id} className="hover:bg-[var(--secondary)]">
                    ...
                    <td className="sticky right-0 bg-white px-4 py-3">
                      <div className="flex items-center gap-1">
                        <Link href={`/admin/tipos/${tipo.id}/editar`} className="inline-flex items-center font-medium border border-blue-500 text-blue-600 rounded px-2 py-1 text-sm hover:bg-blue-50">Editar</Link>
